...
#line 231 "frontend.hh"
    ...
    SLASH = 293,                   // SLASH
    STAR = 294,                    // STAR
    STRINGLITERAL = 295,           // STRINGLITERAL
    TAKE = 296,                    // TAKE
    TRUE = 297,                    // TRUE
    VOID = 298,                    // VOID
    WHILE = 299                    // WHILE
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_SLASH = 38,                            // SLASH
        S_STAR = 39,                             // STAR
        S_STRINGLITERAL = 40,                    // STRINGLITERAL
        S_TAKE = 41,                             // TAKE
        S_TRUE = 42,                             // TRUE
        S_VOID = 43,                             // VOID
        S_WHILE = 44,                            // WHILE
        ...
        S_classDecl = 52,                        // classDecl
        S_classBody = 53,                        // classBody
        S_fnDecl = 54,                           // fnDecl
        S_formals = 55,                          // formals
        S_formalsList = 56,                      // formalsList
